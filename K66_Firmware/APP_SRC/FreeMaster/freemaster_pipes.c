...
typedef int32_t (*FMSTR_PIPE_ITOA_FUNC)(void*, const void*, FMSTR_PIPE_PRINTF_CTX*);
...
static FMSTR_PIPE* FMSTR_FindPipe(unsigned char nPort);
static unsigned short FMSTR_PipeGetBytesFree(FMSTR_PIPE_BUFF* pbuff);
static unsigned short FMSTR_PipeGetBytesReady(FMSTR_PIPE_BUFF* pbuff);
...
static int32_t FMSTR_PipeIToAFinalize(void* hpipe, FMSTR_PIPE_PRINTF_CTX* pctx);

static int32_t FMSTR_PipePrintfOne(void* hpipe, const char* pszFmt, void* parg, FMSTR_PIPE_ITOA_FUNC pItoaFunc);

static int32_t FMSTR_PipePrintfAny(void* hpipe, va_list* parg, FMSTR_PIPE_PRINTF_CTX* pctx);
static int32_t FMSTR_PipePrintfV(void* hpipe, const char* pszFmt, va_list* parg);

/**********************************************************************
*  local "inline" functions (may also be static on some platforms)
**********************************************************************/

FMSTR_INLINE int32_t FMSTR_PipePrintfFlush(void* hpipe);
FMSTR_INLINE int32_t FMSTR_PipePrintfPutc(void* hpipe, char c);
...
void* FMSTR_PipeOpen(unsigned char nPort, FMSTR_PPIPEFUNC pCallback,
                           uint8_t* pRxBuff, unsigned short nRxSize, 
                           uint8_t* pTxBuff, unsigned short nTxSize)
{
...
unsigned short FMSTR_PipeWrite(void* hpipe, uint8_t* addr, unsigned short length, unsigned short granularity)
{
    FMSTR_PIPE* pp = (FMSTR_PIPE*) hpipe;
    FMSTR_PIPE_BUFF* pbuff = &pp->tx;
    unsigned short total = FMSTR_PipeGetBytesFree(pbuff);
    unsigned short s;
    ...
    if(addr)
    {
        ...
        if(length > 0)
        {
            ...
            s = (unsigned short) ((pbuff->nSize - pbuff->nWP) * FMSTR_CFG_BUS_WIDTH);
            if(s > length)
                s = length;
...
int32_t FMSTR_PipePuts(void* hpipe, const char* pszStr)
{
    FMSTR_PIPE* pp = (FMSTR_PIPE*) hpipe;
    FMSTR_PIPE_BUFF* pbuff = &pp->tx;
    unsigned short free = FMSTR_PipeGetBytesFree(pbuff);
    unsigned short slen = (unsigned short) FMSTR_StrLen((uint8_t*)pszStr);
    
    if(slen > free)
        return FMSTR_FALSE;
    
    FMSTR_PipeWrite(hpipe, (uint8_t*)pszStr, slen, 0);
    return FMSTR_TRUE;
}
...
{
    FMSTR_PIPE* pp = (FMSTR_PIPE*) hpipe;
    int32_t ok = FMSTR_TRUE;
    
    if(pp->printfBPtr)
    {
        FMSTR_SIZE8 sz = (FMSTR_SIZE8) FMSTR_PipeWrite(hpipe, (uint8_t*)pp->printfBuff, (unsigned short)pp->printfBPtr, 0);
...
static int32_t FMSTR_PipeU8ToA(void* hpipe, const uint8_t* parg, FMSTR_PIPE_PRINTF_CTX* pctx)
{
    FMSTR_PIPE* pp = (FMSTR_PIPE*) hpipe;
    uint8_t arg = *parg;
    uint8_t tmp;
...
static int32_t FMSTR_PipeS8ToA(void* hpipe, const int8_t* parg, FMSTR_PIPE_PRINTF_CTX* pctx)
{
    int8_t arg = *parg;
    ...
    return FMSTR_PipeU8ToA(hpipe, (const uint8_t*)&arg, pctx);
}
...
static int32_t FMSTR_PipeU16ToA(void* hpipe, const uint16_t* parg, FMSTR_PIPE_PRINTF_CTX* pctx)
{
    FMSTR_PIPE* pp = (FMSTR_PIPE*) hpipe;
    uint16_t arg = *parg;
    uint16_t tmp;
...
static int32_t FMSTR_PipeS16ToA(void* hpipe, const int16_t* parg, FMSTR_PIPE_PRINTF_CTX* pctx)
{
    int16_t arg = *parg;
    ...
    return FMSTR_PipeU16ToA(hpipe, (const uint16_t*)&arg, pctx);
}
...
static int32_t FMSTR_PipeU32ToA(void* hpipe, const uint32_t* parg, FMSTR_PIPE_PRINTF_CTX* pctx)
{
    FMSTR_PIPE* pp = (FMSTR_PIPE*) hpipe;
    uint32_t arg = *parg;
    uint32_t tmp;
...
static int32_t FMSTR_PipeS32ToA(void* hpipe, const int32_t* parg, FMSTR_PIPE_PRINTF_CTX* pctx)
{
    int32_t arg = *parg;
    ...
    return FMSTR_PipeU32ToA(hpipe, (const uint32_t*)&arg, pctx);
}
...
int32_t FMSTR_PipePrintfU8(void* hpipe, const char* pszFmt, uint8_t arg)
{
...
int32_t FMSTR_PipePrintfS8(void* hpipe, const char* pszFmt, int8_t arg)
{
...
int32_t FMSTR_PipePrintfU16(void* hpipe, const char* pszFmt, uint16_t arg)
{
...
int32_t FMSTR_PipePrintfS16(void* hpipe, const char* pszFmt, int16_t arg)
{
...
static int32_t FMSTR_PipePrintfAny(void* hpipe, va_list* parg, FMSTR_PIPE_PRINTF_CTX* pctx)
{
    ...
    switch(pctx->dtsize)
    {
        case 1:
            if(pctx->flags.flg.signedtype)
            {
                int8_t arg = (int8_t)va_arg(*parg, int);
                ok = FMSTR_PipeS8ToA(hpipe, &arg, pctx);
            }
            else
            {
                uint8_t arg = (uint8_t)va_arg(*parg, unsigned);
        ...
        case 2:
            if(pctx->flags.flg.signedtype)
            {
                int16_t arg = (int16_t)va_arg(*parg, int);
                ok = FMSTR_PipeS16ToA(hpipe, &arg, pctx);
            }
            else
            {
                uint16_t arg = (uint16_t)va_arg(*parg, unsigned);
        ...
        case 4:
            if(pctx->flags.flg.signedtype)
            {
                int32_t arg = (int32_t)va_arg(*parg, long);
                ok = FMSTR_PipeS32ToA(hpipe, &arg, pctx);
            }
            else
            {
                uint32_t arg = (uint32_t)va_arg(*parg, unsigned long);
...
unsigned short FMSTR_PipeRead(void* hpipe, uint8_t* addr, unsigned short length, unsigned short granularity)
{
    FMSTR_PIPE* pp = (FMSTR_PIPE*) hpipe;
    FMSTR_PIPE_BUFF* pbuff = &pp->rx;
    unsigned short total = FMSTR_PipeGetBytesReady(pbuff);
    unsigned short s;
    ...
    if(addr)
    {
        ...
        {
            /* total bytes available in the rest of buffer */
            s = (unsigned short) ((pbuff->nSize - pbuff->nRP) * FMSTR_CFG_BUS_WIDTH);
            if(s > length)
                s = length;
...
static unsigned short FMSTR_PipeGetBytesFree(FMSTR_PIPE_BUFF* pbuff)
{
    ...
    {
        free = (unsigned short)(pbuff->nRP - pbuff->nWP);
    }
    else
    {
        free = (unsigned short)(pbuff->nSize - pbuff->nWP + pbuff->nRP);
    }
    
    return (unsigned short)(free * FMSTR_CFG_BUS_WIDTH);
}
...
static unsigned short FMSTR_PipeGetBytesReady(FMSTR_PIPE_BUFF* pbuff)
{
    ...
    if(pbuff->flags.flg.bIsFull)
    {
        full = (unsigned short)pbuff->nSize;
    }
    else if(pbuff->nWP >= pbuff->nRP)
    {
        full = (unsigned short)(pbuff->nWP - pbuff->nRP);
    }
    else
    {
        full = (unsigned short)(pbuff->nSize - pbuff->nRP + pbuff->nWP);
    }
    
    return (unsigned short)(full * FMSTR_CFG_BUS_WIDTH);
}

static void FMSTR_PipeDiscardBytes(FMSTR_PIPE_BUFF* pbuff, FMSTR_SIZE8 count)
{
    unsigned short rest = (unsigned short)(pbuff->nSize - pbuff->nRP);
    unsigned short total, rp;
    unsigned short discard;
    
    total = FMSTR_PipeGetBytesReady(pbuff);
    discard = (unsigned short) (count > total ? total : count);
    ...
    if(discard > 0)
    {
        ...
        if(rest <= discard)
        {
            rp = (unsigned short) (discard - rest);
        }
        else
        {
            rp = (unsigned short) (pbuff->nRP + discard);
        }
...
{
    FMSTR_PIPE_BUFF* pbuff = &pp->tx;
    unsigned short s, nRP = pbuff->nRP;
    
    if(size > 0)
    {
        /* total bytes available in the rest of buffer */
        s = (unsigned short) ((pbuff->nSize - nRP) * FMSTR_CFG_BUS_WIDTH);
        if(s > (unsigned short) size)
            s = (unsigned short) size;
...
FMSTR_BPTR FMSTR_PipeFrame(FMSTR_BPTR pMessageIO)
{
    ...
    /* get pipe by port */
    pp = FMSTR_FindPipe((unsigned char)(nPort & 0x7f));
    ...
    if(nFrameLen > 0)
    {
        ...
        if(nFrameLen > 2)
        {
            ...
            unsigned short rxFree = FMSTR_PipeGetBytesFree(&pp->rx);
            /* how many bytes PC want to push? */
            uint8_t rxToRead = (uint8_t)(nFrameLen - 2);
            ...
            if(rxFree < (unsigned short)rxToRead)
                rxToRead = (uint8_t)rxFree;
    ...
    /* now put our output data */
    {
        ...
        unsigned short txAvail = FMSTR_PipeGetBytesReady(&pp->tx);
        /* how many bytes I can safely put? */
        uint8_t txToSend = FMSTR_COMM_BUFFER_SIZE - 3;
        ...
        if(txAvail < (unsigned short)txToSend)
            txToSend = (uint8_t)txAvail;
        
        /* build frame length */
        nFrameLen = (uint8_t)(txToSend + 2);
...
uint16_t FMSTR_PipeWrite(void* hpipe, uint8_t* addr, unsigned short size, unsigned short granularity)
{
    FMSTR_UNUSED(hpipe);
    FMSTR_UNUSED(addr);
    FMSTR_UNUSED(size);
...
uint16_t FMSTR_PipeRead(void* hpipe, uint8_t* addr, unsigned short size, unsigned short granularity)
{
    FMSTR_UNUSED(hpipe);
    FMSTR_UNUSED(addr);
    FMSTR_UNUSED(size);
