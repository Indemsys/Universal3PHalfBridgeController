...
extern void             _msg_swap_endian_data(unsigned char *, MESSAGE_HEADER_STRUCT_PTR);
...
extern bool             _msgpool_create_system(uint16_t, uint16_t, uint16_t, uint16_t);
...
extern _mqx_uint        _msgq_get_notification_function(_queue_id, MSGQ_NOTIFICATION_FPTR *, void **);
extern _queue_id        _msgq_open(_queue_number, uint16_t);
extern _queue_id        _msgq_open_system(_queue_number, uint16_t, MSGQ_NOTIFICATION_FPTR, void *);
...
extern MSGQ_NOTIFICATION_FPTR _msgq_set_notification_function(_queue_id, MSGQ_NOTIFICATION_FPTR, void *);
