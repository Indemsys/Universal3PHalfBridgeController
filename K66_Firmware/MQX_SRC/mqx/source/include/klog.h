...
#define KLOG_ENABLED                  (uint32_t)(0x00000001)

/* Enable logging of function entry/exit points. */
#define KLOG_FUNCTIONS_ENABLED        (uint32_t)(0x00000002)

/* Enable logging of interrupts. */
#define KLOG_INTERRUPTS_ENABLED       (uint32_t)(0x00000004)

/* Enable logging of system clock tick interrupt. */
#define KLOG_SYSTEM_CLOCK_INT_ENABLED (uint32_t)(0x00000008)

/* Enable logging of context switches. */
#define KLOG_CONTEXT_ENABLED          (uint32_t)(0x00000010)

/* Enable task qualification checking of logs. */
#define KLOG_TASK_QUALIFIED           (uint32_t)(0x00000020)
 ...
 */
#define KLOG_TASKING_FUNCTIONS        (uint32_t)(0x00000100)
#define KLOG_ERROR_FUNCTIONS          (uint32_t)(0x00000200)
#define KLOG_MESSAGE_FUNCTIONS        (uint32_t)(0x00000400)
#define KLOG_INTERRUPT_FUNCTIONS      (uint32_t)(0x00000800)
#define KLOG_MEMORY_FUNCTIONS         (uint32_t)(0x00001000)
#define KLOG_TIME_FUNCTIONS           (uint32_t)(0x00002000)
#define KLOG_EVENT_FUNCTIONS          (uint32_t)(0x00004000)
#define KLOG_NAME_FUNCTIONS           (uint32_t)(0x00008000)
#define KLOG_MUTEX_FUNCTIONS          (uint32_t)(0x00010000)
#define KLOG_SEMAPHORE_FUNCTIONS      (uint32_t)(0x00020000)
#define KLOG_WATCHDOG_FUNCTIONS       (uint32_t)(0x00040000)
#define KLOG_PARTITION_FUNCTIONS      (uint32_t)(0x00080000)
#define KLOG_IO_FUNCTIONS             (uint32_t)(0x00100000)
#define KLOG_EDS_FUNCTIONS            (uint32_t)(0x00200000)
#define KLOG_RTCS_FUNCTIONS           (uint32_t)(0x02000000)

#define KLOG_FUNCTION_MASK            (uint32_t)(0xFFFFFF00)
...
#define KLOG_task_enable_preemption            (KLOG_TASKING_FUNCTIONS+39) 
...
#define KLOG_lwmsgq_deinit                     (KLOG_MESSAGE_FUNCTIONS+31)
#define KLOG_msgq_receive_internal             (KLOG_MESSAGE_FUNCTIONS+32)
...
#define KLOG_mem_alloc_align_from              (KLOG_MEMORY_FUNCTIONS+35)
#define KLOG_mem_alloc_system_align            (KLOG_MEMORY_FUNCTIONS+36)
#define KLOG_mem_alloc_system_align_from       (KLOG_MEMORY_FUNCTIONS+37)

#define KLOG_lwmem_alloc_system_align          (KLOG_MEMORY_FUNCTIONS+38)
#define KLOG_lwmem_alloc_system_align_from     (KLOG_MEMORY_FUNCTIONS+39)

#define KLOG_lwmem_realloc                     (KLOG_MEMORY_FUNCTIONS+40)   
#define KLOG_lwmem_alloc_extend_internal       (KLOG_MEMORY_FUNCTIONS+41)  
#define KLOG_lwmem_free_part_internal          (KLOG_MEMORY_FUNCTIONS+42)   
#define KLOG_mem_realloc                       (KLOG_MEMORY_FUNCTIONS+43)  
#define KLOG_mem_alloc_extend_internal         (KLOG_MEMORY_FUNCTIONS+44)   
#define KLOG_mem_free_part_internal            (KLOG_MEMORY_FUNCTIONS+45)  

#define KLOG_tlsf_free                          (KLOG_MEMORY_FUNCTIONS+46)
#define KLOG_tlsf_alloc                         (KLOG_MEMORY_FUNCTIONS+47)
#define KLOG_tlsf_alloc_from                    (KLOG_MEMORY_FUNCTIONS+48)
#define KLOG_tlsf_alloc_zero                    (KLOG_MEMORY_FUNCTIONS+49)
#define KLOG_tlsf_alloc_system                  (KLOG_MEMORY_FUNCTIONS+50)
#define KLOG_tlsf_alloc_system_from             (KLOG_MEMORY_FUNCTIONS+51)
#define KLOG_tlsf_alloc_system_zero             (KLOG_MEMORY_FUNCTIONS+52)
#define KLOG_tlsf_alloc_system_zero_from        (KLOG_MEMORY_FUNCTIONS+53)
#define KLOG_tlsf_transfer                      (KLOG_MEMORY_FUNCTIONS+54)
#define KLOG_tlsf_create_pool                   (KLOG_MEMORY_FUNCTIONS+55)
#define KLOG_tlsf_alloc_align                   (KLOG_MEMORY_FUNCTIONS+56)
#define KLOG_tlsf_alloc_align_from              (KLOG_MEMORY_FUNCTIONS+57)
#define KLOG_tlsf_alloc_zero_from               (KLOG_MEMORY_FUNCTIONS+58)
#define KLOG_tlsf_alloc_system_align            (KLOG_MEMORY_FUNCTIONS+59)
#define KLOG_tlsf_alloc_system_align_from       (KLOG_MEMORY_FUNCTIONS+60)
#define KLOG_tlsf_alloc_uncached                (KLOG_MEMORY_FUNCTIONS+61)
#define KLOG_tlsf_alloc_align_uncached          (KLOG_MEMORY_FUNCTIONS+62)
#define KLOG_tlsf_alloc_system_uncached         (KLOG_MEMORY_FUNCTIONS+63)
#define KLOG_tlsf_alloc_system_zero_uncached    (KLOG_MEMORY_FUNCTIONS+64)
#define KLOG_tlsf_extend                        (KLOG_MEMORY_FUNCTIONS+65)
#define KLOG_tlsf_extend_pool                   (KLOG_MEMORY_FUNCTIONS+66)
#define KLOG_tlsf_realloc                       (KLOG_MEMORY_FUNCTIONS+67)
#define KLOG_lwmem_test                         (KLOG_MEMORY_FUNCTIONS+68)
...
#define KLOG_partition_calculate_blocks        (KLOG_PARTITION_FUNCTIONS+13)
...
#define KLOG_lwevent_wait_internal             (KLOG_EVENT_FUNCTIONS+31)
...
#define KLOG_sem_wait_internal                 (KLOG_SEMAPHORE_FUNCTIONS+24)
