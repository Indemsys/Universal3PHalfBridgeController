...
extern bool   _mem_check_coalesce_internal(STOREBLOCK_STRUCT_PTR);
extern _mqx_uint _mem_create_pool_internal(void *, void *, MEMPOOL_STRUCT_PTR);
extern _mqx_uint _mem_extend_pool_internal(void *, _mem_size, MEMPOOL_STRUCT_PTR);
#endif
