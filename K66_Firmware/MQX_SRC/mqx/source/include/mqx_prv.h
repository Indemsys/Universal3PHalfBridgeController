...
typedef struct  kernel_data_struct
{
   ...
   /******************************************************/
   /*     DO NOT CHANGE any item before this line !!!    */
   /* !!! asm use hardcoded index of structure items !!! */
   /******************************************************/
...
#if !MQX_USE_IO_OLD
   /*! \brief FD table presentation - pointer to file descriptors table. */
   NIO_FD_TBL_STRUCT *FD_TABLE;
   /*! \brief Installed device list */
   NIO_DEV_LIST_STRUCT DEV_LIST;
#endif // MQX_USE_IO_OLD

#if MQX_HAS_CONTEXT_SWITCH_HANDLER
   /*! \brief The address of the last task descriptor being actived. */
   TD_STRUCT_PTR                   OLD_ACTIVE_PTR;

   /*! \brief An address of context switch callback used by _mqx_context_switch_internal. */
   MQX_CONTEXT_SWITCH_FPTR        CONTEXT_SWITCH_HANDLER;
#endif

#if MQX_MEM_MONITOR
   _mem_size                       MEM_HIGHEST_USED;
   _mem_size                       MEM_USED;
#endif
...
extern char         *_klog_get_function_name_internal(uint32_t);
...
extern _task_id      _task_create_internal(_processor_number, _mqx_uint, uint32_t, bool);
extern TD_STRUCT_PTR _task_alloc_td_internal(_mem_size, _mem_size_ptr, void *, _mqx_uint);
extern TD_STRUCT_PTR _task_build_internal(_mqx_uint, uint32_t, void *, _mem_size, bool);
extern void          _task_fill_stack_internal(_mqx_uint_ptr, _mqx_uint);
extern TD_STRUCT_PTR _task_init_internal(TASK_TEMPLATE_STRUCT_PTR, _task_id, uint32_t, bool, void *, _mem_size);
extern void          _task_ready_internal(TD_STRUCT_PTR);
extern _mqx_uint     _task_set_error_td_internal(TD_STRUCT_PTR, _mqx_uint);
extern _mqx_uint     _task_destroy_internal(_task_id, bool);
extern _mqx_uint     _task_abort_internal(_task_id, bool);
 ...
 */
#if MQX_USE_MEM
extern void         *_mem_alloc_internal(_mem_size, TD_STRUCT_PTR, MEMPOOL_STRUCT_PTR, _mqx_uint_ptr);
extern void         *_mem_alloc_at_internal(_mem_size, void *, TD_STRUCT_PTR, MEMPOOL_STRUCT_PTR, _mqx_uint_ptr);
extern void         *_mem_alloc_internal_align(_mem_size, _mem_size, TD_STRUCT_PTR, MEMPOOL_STRUCT_PTR, _mqx_uint_ptr);
extern _mqx_uint     _mem_alloc_extend_internal(void *, _mem_size);
extern _mqx_uint     _mem_free_part_internal(void *, _mem_size);
extern _mqx_uint     _mem_coalesce_internal(STOREBLOCK_STRUCT_PTR);
extern void         *_mem_get_next_block_internal(TD_STRUCT_PTR, void *);
extern _mqx_uint     _mem_init_internal(void);
extern _mqx_uint     _mem_transfer_td_internal(void *, TD_STRUCT_PTR, TD_STRUCT_PTR);
extern void          _mem_transfer_internal(void *, TD_STRUCT_PTR);
#endif/* MQX_USE_MEM */
...
extern _mqx_uint     _sched_set_rr_interval_internal(_task_id, MQX_TICK_STRUCT_PTR, MQX_TICK_STRUCT_PTR);
extern _mqx_uint     _sched_get_rr_interval_internal(_task_id, MQX_TICK_STRUCT_PTR);
...
extern uint32_t       _task_get_parameter_internal(TD_STRUCT_PTR);
extern uint32_t       _task_set_parameter_internal(uint32_t, TD_STRUCT_PTR);
extern void          _task_sync_priority_internal(TD_STRUCT_PTR);

extern       bool     _time_check_if_leap(uint16_t);
...
extern bool          _psp_build_stack_frame(TD_STRUCT_PTR, void *, _mem_size, TASK_TEMPLATE_STRUCT_PTR, _mqx_uint, uint32_t);
...
extern _mqx_uint     _lwsem_create_internal(LWSEM_STRUCT_PTR, _mqx_int, bool, bool);
extern _mqx_uint     _lwsem_destroy_internal(LWSEM_STRUCT_PTR sem_ptr, bool user);

extern _mqx_uint     _mqx_api_call(MQX_API_NUMBER_ENUM, MQX_API_CALL_PARAMS_PTR);
extern void          _mqx_context_switch_internal(void);
...
/** Function install BSP specific drivers to MQX.
