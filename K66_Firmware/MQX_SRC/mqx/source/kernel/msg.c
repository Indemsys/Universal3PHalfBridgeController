...
{ /* Body */
    ...
    if (kernel_data->IN_ISR)
    {
        _KLOGX2(KLOG_msg_create_component, MQX_CANNOT_CALL_FUNCTION_FROM_ISR);
 ...
 * \see MESSAGE_HEADER_STRUCT
 */
static const unsigned char _KRNL_Hdr_def[] =
{
    sizeof(_msg_size),
...
{ /* Body */
    ...
    _mem_swap_endian( (unsigned char *)_KRNL_Hdr_def, (void *)&(message_ptr->SIZE));
...
{ /* Body */
    ...
    _mem_swap_endian( definition, (void *)((unsigned char *)message_ptr +
