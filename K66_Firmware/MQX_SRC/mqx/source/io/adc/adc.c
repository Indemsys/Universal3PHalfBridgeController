...
{ /* Body */
   ...
   if (NULL == (adc_driver_bundle = (ADC_DRIVER_BUNDLE_PTR) _mem_alloc_system(sizeof(ADC_DRIVER_BUNDLE))))
...
#else
      adc_driver_bundle->adc_name[ch] = (void *) 0xFFFFFFFF; /* channel is used */
#endif
...
{ /* Body */
    _mqx_int cp_cnt;
    ADC_RESULT_STRUCT      *dst = (ADC_RESULT_STRUCT *) data_ptr;
    ADC_CHANNEL_BUNDLE_PTR adc_channel_bundle = (ADC_CHANNEL_BUNDLE_PTR) f->DEV_DATA_PTR;
