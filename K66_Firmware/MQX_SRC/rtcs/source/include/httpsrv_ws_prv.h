...
#define WS_PING_STRING          "RTCS-HTTPSRV-PING-MESSAGE"
#define WS_MIN(a,b)             (((a) < (b)) ? (a) : (b))
#define WS_NUM_MESSAGES         (5)
#define WS_DO_DEINIT            (RTCS_ERROR)
