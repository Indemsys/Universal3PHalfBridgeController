...
bool MIB_find_mqxTaskEntry        (uint32_t, void *, void **);

static bool MIB_instance_mqxTaskEntry        (RTCSMIB_WALK_PTR, uint32_t, bool (_CODE_PTR_)(uint32_t, void *, void **), bool *, void **);
...
static bool MIB_instance_mqxTaskEntry
   (
...
extern uint32_t MIB_get_mqxConfig64BitInts(void *dummy);
extern uint32_t MIB_get_mqxRevKernel(void *dummy);
extern uint32_t MIB_get_mqxRevPSP(void *dummy);
extern uint32_t MIB_get_mqxRevIO(void *dummy);
extern uint32_t MIB_get_mqxRevBSP(void *dummy);
extern unsigned char *MIB_get_mqxCopyright(void *td);
extern unsigned char *MIB_get_mqxDate(void *td);
extern uint32_t MIB_get_mqxCPUEndian(void *dummy);
extern uint32_t MIB_get_mqxCPUAddressing(void *dummy);
extern uint32_t MIB_get_mqxProcessorNum(void *dummy);
static uint32_t MIB_get_mqxTaskID(void *td);
static uint32_t MIB_get_mqxTaskCreator(void *td);
static unsigned char *MIB_get_mqxTaskName(void *td);
static uint32_t MIB_get_mqxTaskState(void *td);
static uint32_t MIB_get_mqxTaskErrorCode(void *td);
static uint32_t MIB_get_mqxTaskSchedPriority(void *td);
static uint32_t MIB_get_mqxTaskSchedHomePriority(void *td);
static uint32_t MIB_get_mqxTaskSchedPolicy(void *td);
static uint32_t MIB_get_mqxTaskSchedTimeSlice(void *td);
#if MQX_KERNEL_LOGGING
static uint32_t MIB_get_mqxTaskStackSize(void *dummy);
static uint32_t MIB_get_mqxTaskStackUsed(void *dummy);
#endif
static unsigned char *MIB_get_mqxTaskIOstdin(void *td);
static unsigned char *MIB_get_mqxTaskIOstdout(void *td);
static unsigned char *MIB_get_mqxTaskIOstderr(void *td);
#if MQXCFG_ENABLE_FP
static uint32_t MIB_get_mqxTaskFlagFloatingPoint(void *td);
#endif
static uint32_t MIB_get_mqxTaskFlagLoggingEnabled(void *td);
static uint32_t MIB_get_mqxTaskFlagWatchdogEnabled(void *td);
static uint32_t MIB_get_mqxTaskFlagPreemptionDisabled(void *td);

/****************************************************************************/

uint32_t MIB_get_mqxConfig64BitInts(void *dummy)
{
	return(0);	
}

bool MIB_find_mqxTaskEntry
   (
      uint32_t        op,
      void          *index,
      void     **instance
...
{ /* Body */
   ...
   _task_id                tid = (_task_id)*(uint32_t *)index;
   ...
   td_num = 0;
   for (;;) {
     td_ptr = (TD_STRUCT_PTR)((char *)search_ptr - offsetof(TD_STRUCT, TD_LIST_INFO));
   ...
   *(uint32_t *)index = td_ptr->TASK_ID;
   *instance = td_ptr;
   return (td_ptr != NULL);

} /* Endbody */

static uint32_t   MIB_get_mqxTaskID                     (void *td) {return ((TD_STRUCT_PTR)td)->TASK_ID;}
static uint32_t   MIB_get_mqxTaskCreator                (void *td) {return ((TD_STRUCT_PTR)td)->PARENT;}
static uint32_t   MIB_get_mqxTaskSchedTimeSlice         (void *td) 
{
#if PLATFORM_SDK_ENABLED
    return 0;
    ...
    uint32_t ms; _sched_get_rr_interval(((TD_STRUCT_PTR)td)->TASK_ID,&ms); return ms;
    #else
    return 0;
    #endif
#endif
}
static unsigned char *MIB_get_mqxTaskName                   (void *td) {return (unsigned char *)((TD_STRUCT_PTR)td)->TASK_TEMPLATE_PTR->TASK_NAME;}
static uint32_t   MIB_get_mqxTaskState                  (void *td) {return ((TD_STRUCT_PTR)td)->STATE;}
static uint32_t   MIB_get_mqxTaskErrorCode              (void *td) {return ((TD_STRUCT_PTR)td)->TASK_ERROR_CODE;}
static uint32_t   MIB_get_mqxTaskSchedPriority          (void *td) {return ((TD_STRUCT_PTR)td)->MY_QUEUE->PRIORITY;}
static uint32_t   MIB_get_mqxTaskSchedHomePriority      (void *td) {return ((TD_STRUCT_PTR)td)->HOME_QUEUE->PRIORITY;}
static uint32_t   MIB_get_mqxTaskSchedPolicy            (void *td) {
...
#if MQX_KERNEL_LOGGING
static uint32_t   MIB_get_mqxTaskStackSize              (void *td) {
#if PLATFORM_SDK_ENABLED
    return 0;
#else
    uint32_t ss,su; _klog_get_task_stack_usage(((TD_STRUCT_PTR)td)->TASK_ID,&ss,&su); return ss;
#endif
}
static uint32_t   MIB_get_mqxTaskStackUsed              (void *td) {
#if PLATFORM_SDK_ENABLED
    return 0;
#else
    uint32_t ss,su; _klog_get_task_stack_usage(((TD_STRUCT_PTR)td)->TASK_ID,&ss,&su); return su;
#endif
}
#endif

#if MQX_USE_IO_OLD
static unsigned char *MIB_get_mqxTaskIOstdin                (void *td) {return (((TD_STRUCT_PTR)td)->STDIN_STREAM)  ? (unsigned char *)((MQX_FILE_PTR)((TD_STRUCT_PTR)td)->STDIN_STREAM)->DEV_PTR->IDENTIFIER  : NULL;}
static unsigned char *MIB_get_mqxTaskIOstdout               (void *td) {return (((TD_STRUCT_PTR)td)->STDOUT_STREAM) ? (unsigned char *)((MQX_FILE_PTR)((TD_STRUCT_PTR)td)->STDOUT_STREAM)->DEV_PTR->IDENTIFIER : NULL;}
static unsigned char *MIB_get_mqxTaskIOstderr               (void *td) {return (((TD_STRUCT_PTR)td)->STDERR_STREAM) ? (unsigned char *)((MQX_FILE_PTR)((TD_STRUCT_PTR)td)->STDERR_STREAM)->DEV_PTR->IDENTIFIER : NULL;}
#else
static unsigned char *MIB_get_mqxTaskIOstdin                (void *td) {return (unsigned char *) NULL;}
static unsigned char *MIB_get_mqxTaskIOstdout               (void *td) {return (unsigned char *) NULL;}
static unsigned char *MIB_get_mqxTaskIOstderr               (void *td) {return (unsigned char *) NULL;}
#endif

#if MQXCFG_ENABLE_FP
static uint32_t   MIB_get_mqxTaskFlagFloatingPoint      (void *td) {return (((TD_STRUCT_PTR)td)->FLAGS & MQX_FLOATING_POINT_TASK)  ? 1 : 0;}
#endif
static uint32_t   MIB_get_mqxTaskFlagLoggingEnabled     (void *td) {return (((TD_STRUCT_PTR)td)->FLAGS & TASK_LOGGING_ENABLED)     ? 1 : 0;}
static uint32_t   MIB_get_mqxTaskFlagWatchdogEnabled    (void *td) {return (((TD_STRUCT_PTR)td)->FLAGS & TASK_WATCHDOG_STARTED)    ? 1 : 0;}
static uint32_t   MIB_get_mqxTaskFlagPreemptionDisabled (void *td) {return (((TD_STRUCT_PTR)td)->FLAGS & TASK_PREEMPTION_DISABLED) ? 1 : 0;}


uint32_t MIB_get_mqxRevKernel(void *dummy)
{
	return(GEN_REVISION);
}

uint32_t MIB_get_mqxRevPSP(void *dummy)
{
	return(PSP_REVISION);
}

uint32_t MIB_get_mqxRevIO(void *dummy)
{
    #if MQX_USE_IO_OLD
	return(IO_REVISION);
    #else
...
uint32_t MIB_get_mqxRevBSP(void *dummy)
{
#if PLATFORM_SDK_ENABLED
    return 0;
#else
...
unsigned char *MIB_get_mqxCopyright(void *td)
{
	return((unsigned char *)_mqx_copyright);
}

unsigned char *MIB_get_mqxDate(void *td)
{
	return((unsigned char *)_mqx_date );	
}

uint32_t MIB_get_mqxCPUEndian(void *dummy)
{
	return(PSP_ENDIAN);	
}

uint32_t MIB_get_mqxCPUAddressing(void *dummy)
{
	return(PSP_MEMORY_ADDRESSING_CAPABILITY);
}

uint32_t MIB_get_mqxProcessorNum(void *dummy)
{
	//TBD KERNEL_DATA_STRUCT_PTR kd_ptr = _mqx_get_kernel_data();
	return 0;//((uint32_t)kd_ptr->PROCESSOR_NUMBER);	
}
...
const RTCSMIB_VALUE MIBVALUE_mqxTaskFlagLoggingEnabled = {
	RTCSMIB_NODETYPE_UINT_FN,
	(void *)MIB_get_mqxTaskFlagLoggingEnabled
};

const RTCSMIB_VALUE MIBVALUE_mqxTaskFlagWatchdogEnabled = {
	RTCSMIB_NODETYPE_UINT_FN,
	(void *)MIB_get_mqxTaskFlagWatchdogEnabled
};

const RTCSMIB_VALUE MIBVALUE_mqxTaskFlagPreemptionDisabled = {
	RTCSMIB_NODETYPE_UINT_FN,
	(void *)MIB_get_mqxTaskFlagPreemptionDisabled
};
